...
# 注册接口
@main_bp.route("/python4nrl1242/yonghu/register", methods=['POST'])
def python4nrl1242_yonghu_register():
...
# 登录接口
@main_bp.route("/python4nrl1242/yonghu/login", methods=['GET','POST'])
def python4nrl1242_yonghu_login():
...
# 登出接口
@main_bp.route("/python4nrl1242/yonghu/logout", methods=['POST'])
def python4nrl1242_yonghu_logout():
    if request.method == 'POST':#post请求
        msg = {
            "msg": "退出成功",
            "code": 0
...
# 重置密码接口
@main_bp.route("/python4nrl1242/yonghu/resetPass", methods=['POST'])
def python4nrl1242_yonghu_resetpass():
    if request.method == 'POST':#post请求
...
# 获取会话信息接口
@main_bp.route("/python4nrl1242/yonghu/session", methods=['GET'])
def python4nrl1242_yonghu_session():
...
# 分类接口（后端）
@main_bp.route("/python4nrl1242/yonghu/page", methods=['GET'])
def python4nrl1242_yonghu_page():
    if request.method == 'GET':#get请求
...
# 排序接口
@main_bp.route("/python4nrl1242/yonghu/autoSort", methods=['GET'])
def python4nrl1242_yonghu_autosort():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
        #获取传递的参数
        req_dict = session.get("req_dict")
...
#查询单条数据
@main_bp.route("/python4nrl1242/yonghu/query", methods=['GET'])
def python4nrl1242_yonghu_query():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success",  "data":{}}
        #获取传递的参数，根据参数获取单条结果
        req_dict = session.get("req_dict")
...
# 分页接口（前端）
@main_bp.route("/python4nrl1242/yonghu/list", methods=['GET'])
def python4nrl1242_yonghu_list():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
        #获取传递的参数
        req_dict = session.get("req_dict")
...
# 保存接口（后端）
@main_bp.route("/python4nrl1242/yonghu/save", methods=['POST'])
def python4nrl1242_yonghu_save():
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #获取传递的参数
        req_dict = session.get("req_dict")
...
# 添加接口（前端）
@main_bp.route("/python4nrl1242/yonghu/add", methods=['POST'])
def python4nrl1242_yonghu_add():
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #获取参数
        req_dict = session.get("req_dict")
...
# 踩、赞接口
@main_bp.route("/python4nrl1242/yonghu/thumbsup/<id_>", methods=['GET'])
def python4nrl1242_yonghu_thumbsup(id_):
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        req_dict = session.get("req_dict")
        id_=int(id_)
...
# 获取详情信息（后端）
@main_bp.route("/python4nrl1242/yonghu/info/<id_>", methods=['GET'])
def python4nrl1242_yonghu_info(id_):
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #根据id获取对应记录
...
# 获取详情信息（前端）
@main_bp.route("/python4nrl1242/yonghu/detail/<id_>", methods=['GET'])
def python4nrl1242_yonghu_detail(id_):
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #根据id获取对应记录
        data = yonghu.getbyid(yonghu, yonghu, int(id_))
...
# 更新接口
@main_bp.route("/python4nrl1242/yonghu/update", methods=['POST'])
def python4nrl1242_yonghu_update():
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        req_dict = session.get("req_dict")
...
# 删除接口
@main_bp.route("/python4nrl1242/yonghu/delete", methods=['POST'])
def python4nrl1242_yonghu_delete():
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        req_dict = session.get("req_dict")
        #删除记录
...
# 投票接口
@main_bp.route("/python4nrl1242/yonghu/vote/<int:id_>", methods=['POST'])
def python4nrl1242_yonghu_vote(id_):
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success"}
        #根据id获取记录
        data= yonghu.getbyid(yonghu, yonghu, int(id_))
...
#获取所有记录列表
@main_bp.route("/python4nrl1242/yonghu/lists", methods=['GET'])
def python4nrl1242_yonghu_lists():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": []}
