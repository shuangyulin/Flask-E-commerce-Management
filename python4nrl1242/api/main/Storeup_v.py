...
# 注册接口
@main_bp.route("/python4nrl1242/storeup/register", methods=['POST'])
def python4nrl1242_storeup_register():
...
# 登录接口
@main_bp.route("/python4nrl1242/storeup/login", methods=['GET','POST'])
def python4nrl1242_storeup_login():
...
# 登出接口
@main_bp.route("/python4nrl1242/storeup/logout", methods=['POST'])
def python4nrl1242_storeup_logout():
    if request.method == 'POST':#post请求
        msg = {
            "msg": "退出成功",
            "code": 0
...
# 重置密码接口
@main_bp.route("/python4nrl1242/storeup/resetPass", methods=['POST'])
def python4nrl1242_storeup_resetpass():
    if request.method == 'POST':#post请求
...
# 获取会话信息接口
@main_bp.route("/python4nrl1242/storeup/session", methods=['GET'])
def python4nrl1242_storeup_session():
...
# 分类接口（后端）
@main_bp.route("/python4nrl1242/storeup/page", methods=['GET'])
def python4nrl1242_storeup_page():
    if request.method == 'GET':#get请求
...
# 排序接口
@main_bp.route("/python4nrl1242/storeup/autoSort", methods=['GET'])
def python4nrl1242_storeup_autosort():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
        #获取传递的参数
        req_dict = session.get("req_dict")
...
#查询单条数据
@main_bp.route("/python4nrl1242/storeup/query", methods=['GET'])
def python4nrl1242_storeup_query():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success",  "data":{}}
        #获取传递的参数，根据参数获取单条结果
        req_dict = session.get("req_dict")
...
# 分页接口（前端）
@main_bp.route("/python4nrl1242/storeup/list", methods=['GET'])
def python4nrl1242_storeup_list():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
        #获取传递的参数
        req_dict = session.get("req_dict")
...
# 保存接口（后端）
@main_bp.route("/python4nrl1242/storeup/save", methods=['POST'])
def python4nrl1242_storeup_save():
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #获取传递的参数
        req_dict = session.get("req_dict")
...
# 添加接口（前端）
@main_bp.route("/python4nrl1242/storeup/add", methods=['POST'])
def python4nrl1242_storeup_add():
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #获取参数
        req_dict = session.get("req_dict")
...
# 踩、赞接口
@main_bp.route("/python4nrl1242/storeup/thumbsup/<id_>", methods=['GET'])
def python4nrl1242_storeup_thumbsup(id_):
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        req_dict = session.get("req_dict")
        id_=int(id_)
...
# 获取详情信息（后端）
@main_bp.route("/python4nrl1242/storeup/info/<id_>", methods=['GET'])
def python4nrl1242_storeup_info(id_):
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #根据id获取对应记录
...
# 获取详情信息（前端）
@main_bp.route("/python4nrl1242/storeup/detail/<id_>", methods=['GET'])
def python4nrl1242_storeup_detail(id_):
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #根据id获取对应记录
        data = storeup.getbyid(storeup, storeup, int(id_))
...
# 更新接口
@main_bp.route("/python4nrl1242/storeup/update", methods=['POST'])
def python4nrl1242_storeup_update():
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        req_dict = session.get("req_dict")
        #如果存在密码或点击次数则不更新
...
# 删除接口
@main_bp.route("/python4nrl1242/storeup/delete", methods=['POST'])
def python4nrl1242_storeup_delete():
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        req_dict = session.get("req_dict")
        #删除记录
...
# 投票接口
@main_bp.route("/python4nrl1242/storeup/vote/<int:id_>", methods=['POST'])
def python4nrl1242_storeup_vote(id_):
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success"}
        #根据id获取记录
        data= storeup.getbyid(storeup, storeup, int(id_))
...
#获取所有记录列表
@main_bp.route("/python4nrl1242/storeup/lists", methods=['GET'])
def python4nrl1242_storeup_lists():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": []}
