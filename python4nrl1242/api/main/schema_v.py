...
@main_bp.route("/python4nrl1242/cal/<tableName>/<columnName>", methods=['GET'])
def python4nrl1242_cal(tableName, columnName):
    '''
    计算规则接口
    '''
...
@main_bp.route("/python4nrl1242/file/download", methods=['GET'])
def python4nrl1242_file_download():
    '''
    '''
    if request.method == 'GET':
...
@main_bp.route("/python4nrl1242/file/upload", methods=['POST'])
def python4nrl1242_file_upload():
    '''
    '''
...
@main_bp.route("/python4nrl1242/follow/<tableName>/<columnName>/<level>/<parent>", methods=['GET'])
def python4nrl1242_follow_level(tableName, columnName, level,parent):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/python4nrl1242/follow/<tableName>/<columnName>", methods=['GET'])
def python4nrl1242_follow(tableName, columnName):
    '''
...
@main_bp.route("/python4nrl1242/location", methods=['GET'])
def python4nrl1242_location():
    '''
...
@main_bp.route("/python4nrl1242/matchFace", methods=['GET'])
def python4nrl1242_matchface():
    '''
    baidubce百度人脸识别
    '''
    if request.method == 'GET':
...
@main_bp.route("/python4nrl1242/option/<tableName>/<columnName>", methods=['GET'])
def python4nrl1242_option(tableName, columnName):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/python4nrl1242/remind/<tableName>/<columnName>/<type>", methods=['GET'])  #
def python4nrl1242_remind(tableName, columnName,type):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/python4nrl1242/sh/<tableName>", methods=['POST'])
def python4nrl1242_sh(tableName):
    '''
    '''
    if request.method == 'POST':
        ...
        logging.warning("python4nrl1242_sh.res=====>{}".format(res))
        return jsonify(msg)

@main_bp.route("/python4nrl1242/upload/<path:filepath>", methods=['GET'])
def python4nrl1242_upload(filepath):
    '''
    上传接口
    '''
    if request.method == 'GET':
...
@main_bp.route("/python4nrl1242/group/<tableName>/<columnName>", methods=['GET'])
...
@main_bp.route("/python4nrl1242/value/<tableName>/<xColumnName>/<yColumnName>", methods=['GET'])
