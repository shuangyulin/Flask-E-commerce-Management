...
def before_request():
    ...
    if request.method == 'GET':
        get_list = [
            "/",
            "/apidocs/",
             "/python4nrl1242/examusers/login" ,
            "/python4nrl1242/examusers/register",
            '/python4nrl1242/defaultuser/login',
            '/python4nrl1242/users/login',
        ]  # 免认证list
        ...
        post_list = [
            '/python4nrl1242/defaultuser/register',
            '/python4nrl1242/defaultuser/login',
            '/python4nrl1242/users/register',
            '/python4nrl1242/users/login',
            "/python4nrl1242/examusers/login" ,
            "/python4nrl1242/examusers/register"
        ]  # 免认证list
