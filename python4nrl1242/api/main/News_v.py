...
# 注册接口
@main_bp.route("/python4nrl1242/news/register", methods=['POST'])
def python4nrl1242_news_register():
...
# 登录接口
@main_bp.route("/python4nrl1242/news/login", methods=['GET','POST'])
def python4nrl1242_news_login():
...
# 登出接口
@main_bp.route("/python4nrl1242/news/logout", methods=['POST'])
def python4nrl1242_news_logout():
    if request.method == 'POST':#post请求
        msg = {
            "msg": "退出成功",
            "code": 0
...
# 重置密码接口
@main_bp.route("/python4nrl1242/news/resetPass", methods=['POST'])
def python4nrl1242_news_resetpass():
    if request.method == 'POST':#post请求
...
# 获取会话信息接口
@main_bp.route("/python4nrl1242/news/session", methods=['GET'])
def python4nrl1242_news_session():
...
# 分类接口（后端）
@main_bp.route("/python4nrl1242/news/page", methods=['GET'])
def python4nrl1242_news_page():
    if request.method == 'GET':#get请求
...
# 排序接口
@main_bp.route("/python4nrl1242/news/autoSort", methods=['GET'])
def python4nrl1242_news_autosort():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
        #获取传递的参数
        req_dict = session.get("req_dict")
...
#查询单条数据
@main_bp.route("/python4nrl1242/news/query", methods=['GET'])
def python4nrl1242_news_query():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success",  "data":{}}
        #获取传递的参数，根据参数获取单条结果
        req_dict = session.get("req_dict")
...
# 分页接口（前端）
@main_bp.route("/python4nrl1242/news/list", methods=['GET'])
def python4nrl1242_news_list():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
        #获取传递的参数
        req_dict = session.get("req_dict")
...
# 保存接口（后端）
@main_bp.route("/python4nrl1242/news/save", methods=['POST'])
def python4nrl1242_news_save():
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #获取传递的参数
        req_dict = session.get("req_dict")
...
# 添加接口（前端）
@main_bp.route("/python4nrl1242/news/add", methods=['POST'])
def python4nrl1242_news_add():
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #获取参数
        req_dict = session.get("req_dict")
...
# 踩、赞接口
@main_bp.route("/python4nrl1242/news/thumbsup/<id_>", methods=['GET'])
def python4nrl1242_news_thumbsup(id_):
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        req_dict = session.get("req_dict")
        id_=int(id_)
...
# 获取详情信息（后端）
@main_bp.route("/python4nrl1242/news/info/<id_>", methods=['GET'])
def python4nrl1242_news_info(id_):
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #根据id获取对应记录
...
# 获取详情信息（前端）
@main_bp.route("/python4nrl1242/news/detail/<id_>", methods=['GET'])
def python4nrl1242_news_detail(id_):
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #根据id获取对应记录
        data = news.getbyid(news, news, int(id_))
...
# 更新接口
@main_bp.route("/python4nrl1242/news/update", methods=['POST'])
def python4nrl1242_news_update():
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        req_dict = session.get("req_dict")
        #如果存在密码或点击次数则不更新
...
# 删除接口
@main_bp.route("/python4nrl1242/news/delete", methods=['POST'])
def python4nrl1242_news_delete():
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        req_dict = session.get("req_dict")
        #删除记录
...
# 投票接口
@main_bp.route("/python4nrl1242/news/vote/<int:id_>", methods=['POST'])
def python4nrl1242_news_vote(id_):
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success"}
        #根据id获取记录
        data= news.getbyid(news, news, int(id_))
...
# 推荐算法接口
@main_bp.route("/python4nrl1242/news/autoSort2", methods=['GET'])
def python4nrl1242_news_autoSort2():
    if request.method == 'GET':#get请求
        leixing = set()
        req_dict = session.get("req_dict")
        userinfo = session.get("params")
...
#获取所有记录列表
@main_bp.route("/python4nrl1242/news/lists", methods=['GET'])
def python4nrl1242_news_lists():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": []}
