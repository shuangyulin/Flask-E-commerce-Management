<template>
	<div :style='{"width":"100%","padding":"30px calc((100% - 1200px)/2)","margin":"0px auto","position":"relative","background":"#EDF0FA"}'>
		...
		<div v-if="storeupType==1" class="section-title" :style='{"padding":"0  165px","margin":"0","color":"#44446D","textAlign":"left","flexDirection":"column","background":"url(http://codegen.caihongy.cn/20250118/8fc0638edcbd47b4bdaa28e8495ba36b.png) no-repeat center center / 100% 100%","display":"flex","width":"100%","lineHeight":"100px","fontSize":"32px","justifyContent":"flex-end","height":"100px"}'>我的收藏</div>
		...
		<el-pagination
			...
			:total="total"
			:style='{"padding":"0","margin":"10px auto","whiteSpace":"nowrap","color":"#333","textAlign":"center","width":"100%","fontWeight":"500","order":"50"}'
